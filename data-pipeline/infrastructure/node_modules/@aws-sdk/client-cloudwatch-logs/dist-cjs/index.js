...
var DeleteTransformerRequest = [3, n0, _DTR, 0, [_lGI], [0]];
var Delivery = [
    3,
    n0,
    _D,
...
var DescribeFieldIndexesRequest = [3, n0, _DFIR, 0, [_lGIo, _nT], [64 | 0, 0]];
...
var DescribeIndexPoliciesRequest = [3, n0, _DIPRes, 0, [_lGIo, _nT], [64 | 0, 0]];
...
var FieldIndex = [3, n0, _FI, 0, [_lGI, _fIN, _lST, _fET, _lET], [0, 0, 1, 1, 1]];
var FieldsData = [3, n0, _FD, 0, [_da], [21]];
var FilteredLogEvent = [3, n0, _FLE, 0, [_lSN, _ti, _m, _iT, _eIv], [0, 1, 0, 1, 0]];
...
var GetDataProtectionPolicyRequest = [3, n0, _GDPPR, 0, [_lGI], [0]];
var GetDataProtectionPolicyResponse = [3, n0, _GDPPRe, 0, [_lGI, _pD, _lUT], [0, 0, 1]];
...
var GetDeliveryRequest = [3, n0, _GDR, 0, [_i], [0]];
var GetDeliveryResponse = [3, n0, _GDRe, 0, [_de], [() => Delivery]];
var GetDeliverySourceRequest = [3, n0, _GDSR, 0, [_n], [0]];
var GetDeliverySourceResponse = [3, n0, _GDSRe, 0, [_dSe], [() => DeliverySource]];
...
var GetLogGroupFieldsRequest = [3, n0, _GLGFR, 0, [_lGN, _tim, _lGI], [0, 1, 0]];
...
var GetTransformerRequest = [3, n0, _GTR, 0, [_lGI], [0]];
...
var IndexPolicy = [3, n0, _IP, 0, [_lGI, _lUTa, _pD, _pN, _so], [0, 1, 0, 0, 0]];
var InputLogEvent = [3, n0, _ILE, 0, [_ti, _m], [1, 0]];
var IntegrationSummary = [3, n0, _IS, 0, [_iN, _iTn, _iS], [0, 0, 0]];
var InternalStreamingException = [
    -3,
    n0,
    _ISE,
    {
...
var ListIntegrationsResponse = [3, n0, _LIRi, 0, [_iSn], [() => IntegrationSummaries]];
...
var ListLogGroupsForQueryResponse = [3, n0, _LLGFQRi, 0, [_lGIo, _nT], [64 | 0, 0]];
...
var LogEvent = [3, n0, _LE, 0, [_ti, _m], [1, 0]];
var LogGroup = [
    3,
    n0,
    _LG,
...
var MetricFilterMatchRecord = [3, n0, _MFMR, 0, [_eN, _eM, _eV], [1, 0, 128 | 0]];
...
var OutputLogEvent = [3, n0, _OLE, 0, [_ti, _m, _iT], [1, 0, 1]];
...
var ParseToOCSF = [3, n0, _PTOCSF, 0, [_so, _eS, _oV], [0, 0, 0]];
...
var PutDataProtectionPolicyRequest = [3, n0, _PDPPR, 0, [_lGI, _pD], [0, 0]];
var PutDataProtectionPolicyResponse = [3, n0, _PDPPRu, 0, [_lGI, _pD, _lUT], [0, 0, 1]];
...
var PutDeliverySourceResponse = [3, n0, _PDSRu, 0, [_dSe], [() => DeliverySource]];
...
var PutIndexPolicyRequest = [3, n0, _PIPR, 0, [_lGI, _pD], [0, 0]];
...
var PutIntegrationResponse = [3, n0, _PIRu, 0, [_iN, _iS], [0, 0]];
...
var PutTransformerRequest = [3, n0, _PTR, 0, [_lGI, _tC], [0, () => Processors]];
...
var QueryInfo = [3, n0, _QI, 0, [_qL, _qI, _qS, _sta, _cTre, _lGN], [0, 0, 0, 0, 1, 0]];
var QueryStatistics = [
    3,
    n0,
    _QS,
...
var ResultField = [3, n0, _RFe, 0, [_fi, _v], [0, 0]];
...
var TransformedLogRecord = [3, n0, _TLR, 0, [_eN, _eM, _tEM], [1, 0, 0]];
...
var DeliverySources = [1, n0, _DSe, 0, () => DeliverySource];
